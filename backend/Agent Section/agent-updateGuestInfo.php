  ...
  <div class="main-container">
    ...
    <script>
      document.getElementById("redirect-btn").addEventListener("click", function () {
        window.location.href = "../Agent Section/agent-showGuest.php";
      });
    </script>
    ...
    $stmt = $conn->prepare("SELECT b.flightId, f.flightDepartureDate as departureDate FROM booking b JOIN flight f ON b.flightId = f.flightId WHERE transactNo = ?");
      ...
      <div class="addguest-wrapper">
        ...
        <div class="wrapper-body">
          ...
          <form action="../Agent Section/functions/agent-updateGuestInfo-code.php" id="guestForm" method="POST">
            ...
            <div class="card">
              ...
              <div
                class="card-header bg-secondary text-white d-flex flex-row justify-content-between align-items-center">
              ...
              <div class="card-body">
                ...
                if ($row = $result->fetch_assoc()) {
                  ...
                  <div class="header-container d-flex flex-row w-100">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                      <div class="form-group mb-3">
                        <label class="mb-2" for="mName">Middle Name <span class="text-danger fw-bold">write N/A if
                            none</span></label>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                      <div class="form-group mb-3">
                        <label class="mb-2" for="age">Age <span class="text-danger fw-bold">*</span> <span
                            id="infant"></span></label>
                    ...
                    <div class="col-md-3">
                      <div class="form-group mb-3">
                        ...
                        <select class="form-control" name="sex" required>
                          <option disabled <?php echo (!isset($row['sex']) || $row['sex'] == '') ? 'selected' : ''; ?>>
                            Select Sex</option>
                    ...
                    <div class="col-md-3">
                      <div class="form-group mb-3">
                        <label class="mb-2" for="nationality">Nationality <span class="text-danger fw-bold">*</span>
                        </label>
                        <input type="text" class="form-control" name="nationality" list="nationality"
                          placeholder="Enter Nationality" value="<?php echo $row['nationality']; ?>" required>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="columns col-md-4">
                      <div class="form-group">
                        ...
                        <input type="date" name="passportIssued" class="form-control"
                          value="<?php echo $row['passportIssuedDate']; ?>" required>
                    ...
                    <div class="col-md-4">
                      <div class="form-group mb-3">
                        <label class="mb-2" for="passportExp">Date of Expiration: <span
                            class="text-danger fw-bold">*</span> <span id="expPassport"
                            class="text-danger"></span></label>
                        <input type="date" name="passportExp" class="form-control"
                          value="<?php echo $row['passportExp']; ?>" required>
                    ...
                    <div class="col-md-4">
                      <div class="form-group mb-4">
                        ...
                        <div class="input-group">
                          <select name="countryCode" class="form-select" value="<?php echo $row['countryCode']; ?>"
                            required>
                            ...
                            <option value="+1-809" <?php echo (isset($row['countryCode']) && $row['countryCode'] == '+1-809') ? 'selected' : ''; ?>>🇩🇴 Dominican Republic (+1-809)
                            </option>
                            ...
                            <option value="+1-670" <?php echo (isset($row['countryCode']) && $row['countryCode'] == '+1-670') ? 'selected' : ''; ?>>Northern Mariana Islands (+1-670)
                            </option>
                            ...
                            <option value="+1-649" <?php echo (isset($row['countryCode']) && $row['countryCode'] == '+1-649') ? 'selected' : ''; ?>>Turks and Caicos Islands (+1-649)
                            </option>
                          ...
                          <input type="tel" class="form-control" id="contactNo" name="contactNo"
                            placeholder="Contact Number" value="<?php echo $row['contactNo']; ?>" required>
                        </div>
                      ...
                      <div class="form-group mb-4">
                        ...
                        <div class="input-group">
                          <select name="2ndcountryCode" class="form-select" value="<?php echo $row['countryCode2']; ?>">
                            ...
                            <option value="+1-809" <?php echo (isset($row['countryCode2']) && $row['countryCode2'] == '+1-809') ? 'selected' : ''; ?>>🇩🇴 Dominican Republic (+1-809)
                            </option>
                            ...
                            <option value="+1-670" <?php echo (isset($row['countryCode2']) && $row['countryCode2'] == '+1-670') ? 'selected' : ''; ?>>Northern Mariana Islands (+1-670)
                            </option>
                            ...
                            <option value="+1-869" <?php echo (isset($row['countryCode2']) && $row['countryCode2'] == '+1-869') ? 'selected' : ''; ?>>Saint Kitts and Nevis (+1-869)
                            </option>
                            ...
                            <option value="+1-649" <?php echo (isset($row['countryCode2']) && $row['countryCode2'] == '+1-649') ? 'selected' : ''; ?>>Turks and Caicos Islands (+1-649)
                            </option>
                    ...
                    <div class="col-md-4">
                      <div class="form-group mb-4">
                        ...
                        <input type="email" name="email" class="form-control" placeholder="Enter Email Address"
                          value="<?php echo $row['emailAdd']; ?>" required>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group mb-3">
                        <label class="mb-2" for="addressLine">Address Line 1 <span
                            class="text-danger fw-bold">*</span></label>
                        <input type="text" name="addressLine" class="form-control" placeholder="Enter Address Line 1"
                          value="<?php echo $row['addressLine1']; ?>" required>
                        <small class="form-text text-muted">E.g., Street, Barangay</small>
                        <!-- Instruction for Address Line 1 -->
                    ...
                    <div class="col-md-6">
                      <div class="form-group mb-3">
                        ...
                        <input type="text" name="2ndaddressLine" class="form-control" placeholder="Enter Address Line 2"
                          value="<?php echo $row['addressLine2']; ?>">
                    ...
                    <div class="col-md-4">
                      <div class="form-group mb-3">
                        <label class="mb-2" for="state">State/Province/Region <span
                            class="text-danger fw-bold">*</span></label>
                        <input type="text" name="state" class="form-control" placeholder="Enter State/Province/Region"
                    ...
                    <div class="col-md-4">
                      <div class="form-group mb-3">
                        <label class="mb-2" for="zipCode">Zip/Postal Code <span
                            class="text-danger fw-bold">*</span></label>
                        <input type="text" name="zipCode" class="form-control" placeholder="Enter Zip/Postal Code"
                    ...
                    <div class="col-md-4">
                      <div class="form-group mb-3">
                        ...
                        <input type="text" name="country" class="form-control" list="countries"
        ...
        <div class="wrapper-footer">
          <div class="card-footer">
            <button type="submit" class="btn btn-primary" id="updateGuestInfo" name="updateGuestInfo">Update Guest
              Information</button>
          </div>
        </div>
        </form>
