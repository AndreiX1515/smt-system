...
$headerPath  = '../../public/templates/header.php';
$navPath     = '../../public/templates/nav_super.php';
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="btn btn-text btn-circle btn-sm absolute inset-e-3 top-3" aria-label="Close" data-overlay="#my-modal">
