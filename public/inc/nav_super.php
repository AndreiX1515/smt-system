<!-- inc/nav_super.php
     Reddit-style sidebar using FlyonUI drawer + collapse accordion.
     Dropdowns: FlyonUI collapse (data-collapse) — accordion mode via JS.
     Active states: JS sets .is-active on .menu-link and .has-active on .menu-item.
     All data-page / data-menu / data-lan-eng attributes preserved.
-->
...
<ul class="menu p-0 gap-0.5" id="navSuperList">
  ...
  <li class="menu-item" data-menu="reservation-management">
    ...
    <ul id="sub-reservation" class="collapse hidden nav-submenu">
      ...
      <li><a class="menu-link side-link" data-page="travel-document-list,travel-document-detail" href="../super/travel-document-list.php" data-lan-eng="Travel Document">Travel Document</a></li>
    </ul>
  </li>

  <!-- ── Sales Management ──────────────────────── -->
  <li class="menu-item" data-menu="sales-management">
    <button type="button"
      class="menu-link collapse-toggle w-full"
      data-collapse="#sub-sales"
      aria-expanded="false">
      <span class="nav-icon" aria-hidden="true">
        <svg width="18" height="13" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M19.0098 0C19.251 0.0380859 19.4365 0.126953 19.7197 0.458984C19.791 0.78125V5.98926C19.791 6.42073 19.4412 6.7705 19.0098 6.77051C18.5783 6.77051 18.2285 6.42073 18.2285 5.98926V2.84668L11.7832 10.1514C11.5289 10.4396 11.1027 10.5002 10.7783 10.2939L5.6582 7.03613L1.40527 12.708C1.14633 13.0529 0.656593 13.1231 0.311523 12.8643C-0.0333031 12.6053 -0.102407 12.1156 0.15625 11.7705L4.84375 5.52051L5.8877 5.33008L11.0527 8.61719L17.2773 1.5625H13.8018C13.3704 1.5625 13.0205 0.349778 13.8018 0H19.0098Z" fill="currentColor" />
        </svg>
      </span>
  ...
  <!-- ── Product Management ────────────────────── -->
  <li class="menu-item" data-menu="product-management">
    <button type="button"
      class="menu-link collapse-toggle w-full"
      data-collapse="#sub-product"
      aria-expanded="false">
      <span class="nav-icon" aria-hidden="true">
        <svg width="18" height="18" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M4.71501 7.86219L12.0483 4.13638C12.333 3.99176 12.6696 3.99176 12.9543 4.13638L20.2876 7.86219C20.6232 8.03271 20.8346 8.37726 20.8346 8.75372V17.2418C20.8346 17.5982 20.645 17.9277 20.3368 18.1066L13.0034 22.3647C12.693 22.545 12.3097 22.545 11.9992 22.3647L4.66583 18.1066C4.35764 17.9277 4.16797 17.5982 4.16797 17.2418V8.75372C4.16797 8.37726 4.37939 8.03271 4.71501 7.86219Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" fill="none" />
          <path d="M4.16797 8.07422L12.5013 12.2409" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
          <path d="M19.7917 8.07422L12.5 12.2409" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
          <path d="M12.5 21.6133V12.2383" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
          <path d="M15.8091 10.5654C16.1796 10.7506 16.6301 10.6004 16.8154 10.2299C17.0006 9.85946 16.8504 9.40895 16.4799 9.22371L16.1445 9.89453L15.8091 10.5654ZM8.33203 5.98828L7.99662 6.6591L15.8091 10.5654L16.1445 9.89453L16.4799 9.22371L8.66744 5.31746L8.33203 5.98828Z" fill="currentColor" />
        </svg>
      </span>
    ...
    <ul id="sub-product" class="collapse hidden nav-submenu">
      ...
      <li><a class="menu-link side-link" data-page="inventory-management" href="../super/inventory-management.php" data-lan-eng="Inventory Management">Inventory Management</a></li>
      <li><a class="menu-link side-link" data-page="template-list,template-detail,template-registration" href="../super/template-list.php" data-lan-eng="Template List">Template List</a></li>
      <li><a class="menu-link side-link" data-page="category-management" href="../super/category-management.php" data-lan-eng="Category Management">Category Management</a></li>
      <li><a class="menu-link side-link" data-page="option-management" href="../super/option-management.php" data-lan-eng="Option Management">Option Management</a></li>
      <li><a class="menu-link side-link" data-page="sale-management" href="../super/sale-management.php" data-lan-eng="Sale Management">Sale Management</a></li>
    </ul>
  </li>
  ...
  <li class="menu-item" data-menu="message-management">
    <a class="menu-link nav-direct-link" href="../super/agent-message-list.php" data-page="agent-message-list">
      <span class="nav-icon" aria-hidden="true">
        <svg width="18" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M14.583 0C15.7335 0 16.6658 0.932606 16.666 2.08301V10.8799C16.6659 12.0303 15.7335 12.9629 14.583 12.9629H4.82129L4.72949 12.9668C4.51884 12.9854 4.31789 13.0678 4.1543 13.2041L1.70898 15.2422L1.57715 15.3369C0.949886 15.7191 0.1199 15.33 0.0117188 14.6035L0 14.4434V2.08301C0.000225362 0.932606 0.932554 0 2.08301 0H14.583ZM2.08301 1.5625C1.7955 1.5625 1.56273 1.79555 1.5625 2.08301V13.3301L3.1543 12.0039L3.33496 11.8662C3.76969 11.5641 4.28829 11.4004 4.82129 11.4004H14.583C14.8706 11.4004 15.1034 11.1674 15.1035 10.8799V2.08301C15.1033 1.79555 14.8705 1.5625 14.583 1.5625H2.08301Z" fill="currentColor" />
        </svg>
      </span>
      <span data-lan-eng="Inquiries">Inquiries</span>
      <span class="nav-unread-badge" id="inquiryUnreadBadge" style="display:none;">0</span>
    </a>
  </li>

  <!-- ── Announcements ─────────────────────────── -->
  <li class="menu-item" data-menu="announcements">
    <button type="button"
      class="menu-link collapse-toggle w-full"
      data-collapse="#sub-announcements"
      aria-expanded="false">
      <span class="nav-icon" aria-hidden="true">
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M16.5 0C17.3284 0 18 0.671573 18 1.5V12C18 12.8284 17.3284 13.5 16.5 13.5H13.5L9 18V13.5H1.5C0.671573 13.5 0 12.8284 0 12V1.5C0 0.671573 0.671573 0 1.5 0H16.5ZM16.5 1.5H1.5V12H10.5V14.379L12.879 12H16.5V1.5ZM13.5 6.75V8.25H4.5V6.75H13.5ZM13.5 3.75V5.25H4.5V3.75H13.5Z" fill="currentColor" />
        </svg>
      </span>
  ...
  <!-- ── Shopping Management ───────────────────── -->
  <li class="menu-item" data-menu="shopping-management">
    <button type="button"
      class="menu-link collapse-toggle w-full"
      data-collapse="#sub-shopping"
      aria-expanded="false">
      <span class="nav-icon" aria-hidden="true">
        <svg width="18" height="18" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M6.33301 17.4167C6.97734 17.4167 7.49967 16.8943 7.49967 16.25C7.49967 15.6057 6.97734 15.0833 6.33301 15.0833C5.68868 15.0833 5.16634 15.6057 5.16634 16.25C5.16634 16.8943 5.68868 17.4167 6.33301 17.4167Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M14.833 17.4167C15.4773 17.4167 15.9997 16.8943 15.9997 16.25C15.9997 15.6057 15.4773 15.0833 14.833 15.0833C14.1887 15.0833 13.6663 15.6057 13.6663 16.25C13.6663 16.8943 14.1887 17.4167 14.833 17.4167Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M0.5 0.916672H3.66667L5.89 11.2617C5.96572 11.6282 6.16727 11.9568 6.46009 12.1908C6.75291 12.4247 7.11856 12.5492 7.49333 12.5417H14.3667C14.7414 12.5492 15.1071 12.4247 15.3999 12.1908C15.6927 11.9568 15.8943 11.6282 15.97 11.2617L17.1667 4.83334H4.83333" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      </span>
  ...
  <li class="menu-item" data-menu="site-settings">
    ...
    <ul id="sub-settings" class="collapse hidden nav-submenu">
      ...
      <li><a class="menu-link side-link" data-page="terms" href="../super/terms.php" data-lan-eng="Terms of Use">Terms of Use</a></li>
      <li><a class="menu-link side-link" data-page="company-information" href="../super/company-information.php" data-lan-eng="Company Information">Company Information</a></li>
      <li><a class="menu-link side-link" data-page="partner-management" href="../super/partner-management.php" data-lan-eng="Partner Management">Partner Management</a></li>
      <li><a class="menu-link side-link" data-page="login-history" href="../super/login-history.php" data-lan-eng="Login History">Login History</a></li>
      <li><a class="menu-link side-link" data-page="status-history" href="../super/status-history.php" data-lan-eng="Status Change History">Status Change History</a></li>
      <li><a class="menu-link side-link" data-page="menu-permission" href="../super/menu-permission.php" data-lan-eng="Menu Permission">Menu Permission</a></li>
    </ul>
  </li>
...
<!-- ══════════════════════════════════════════════════════
     Accordion JS — FlyonUI collapse + active state init
     ══════════════════════════════════════════════════════ -->
<script>
  (function() {
    'use strict';
    ...
    /* ──────────────────────────────────────────────────────
       ACCORDION: close all other panels when one opens.
       FlyonUI fires 'open.collapse' on the PANEL element.
       We find every other open toggle and programmatically
       close it by dispatching a click (FlyonUI listens for
       click on [data-collapse] buttons).
    ────────────────────────────────────────────────────── */
    document.addEventListener('open.collapse', function(e) {
      const openedPanel = e.target; // the <ul id="sub-*">
      const openedId = '#' + openedPanel.id;

      document
        .querySelectorAll('#navSuperList .collapse-toggle')
        .forEach(function(btn) {
          if (btn.getAttribute('data-collapse') === openedId) return; // skip self
          const panelId = btn.getAttribute('data-collapse');
          const panel = panelId ? document.querySelector(panelId) : null;

          // If this panel is currently open, close it
    ...
    /* ──────────────────────────────────────────────────────
       ...
       Reads window.__currentPage (set by your PHP) or falls
       back to ?page= query param.
    ────────────────────────────────────────────────────── */
    ...
    document.querySelectorAll('#navSuperList .side-link[data-page]').forEach(function(link) {
      ...
      if (submenu) {
        var toggle = document.querySelector('[data-collapse="#' + submenu.id + '"]');
        if (toggle && submenu.classList.contains('hidden')) toggle.click();
      }

      /* Mark .menu-item for parent styling */
      var item = link.closest('.menu-item[data-menu]');
