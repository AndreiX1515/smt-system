...
<script>
  (function () {
    ...
    function openPanel(panel, btn) {
      /* close every other open sibling atomically */
      document.querySelectorAll('#navSuperList .nav-submenu.is-open').forEach(function (p) {
        if (p === panel) return;
        var sibBtn = document.querySelector(
          '#navSuperList .collapse-toggle[data-collapse="#' + p.id + '"]'
        );
        closePanel(p, sibBtn);
      });
