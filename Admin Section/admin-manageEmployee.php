...
<head>
  ...
  <title>Manage Accounts - Employee</title>
...
<body>
  <div class="body-container">
    ...
    <div class="main-content-container">
      <div class="navbar">
        <h5 class="title-page">Manage Account - Employee</h5>
      </div>
      ...
      <div class="main-content">
        <div class="table-wrapper">
          ...
          <div class="table-container">
            ...
            WHERE a.accountType = 'employee'
            ORDER BY e.employeeId ASC, a.accountId ASC";  // Prioritizing Employee ID
                              ...
                              <td>
                                  <div class='dropdown-center' style='text-align: center; position: relative;'>
                                      ...
                                      <ul class='dropdown-menu' style='position: absolute; bottom: 100%; left: 50%; transform: translateX(-50%);'>
                                          <li>
                                              <a class='dropdown-item edit' href='#' data-id='{$accountId}' data-bs-toggle='modal' data-bs-target='#editModal'>
                                                  <i class='fas fa-edit'></i> Edit
                                              </a>
                                          </li>
                                          <li>
                                              <a class='dropdown-item delete text-danger' href='#' data-id='{$accountId}' data-bs-toggle='modal' data-bs-target='#deleteModal'>
  ...
  <div class="modal" id="AddAccountModal" tabindex="-1" aria-labelledby="AddAccountModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="editModalLabel">Add Account - Employee</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
          ...
          <form id="addAccountForm">
            ...
            <div class="content-body">
              <div class="row">
                ...
                <div class="columns col-md-4">
                  <label for="accountStatus" class="form-label">Position</label>
                  <select class="form-select" id="empPosition" name="empPosition" required>
                    <option value="" selected disabled>Select Emp. Position</option>
                    <option value="Reservation Officer">Reservation Officer</option>
                    <option value="Liason Officer">Liason Officer</option>
                  </select>
                </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#addAccountForm').submit(function(event) {
        ...
        $.ajax({
          url: '../Admin Section/functions/admin-addAccountEmployee - code.php',
          type: 'POST',
          data: formData,
          processData: false,
          contentType: false,
