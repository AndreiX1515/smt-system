...
<body>
          ...
          <div class="booking-wrapper">
            <div class="card">
              ...
              <div class="row">
                ...
                <input type="text" id="agentCode" name="agentCode" value="<?php echo $_SESSION['agentCode']; ?>" placeholder="Agent Code Input" hidden>
                <input type="text" id="flightId" name="flightId" value="<?php echo $flightid; ?>" placeholder="Flight Id Input" hidden>

                <!-- Adjusted Fields -->
                <input type="text" id="packagePrice" name="packagePrice" value="<?php echo isset($packagePrice) ? $packagePrice : ''; ?>" placeholder="Package Price" hidden>
                <input type="text" name="flightPrice" id="flightPricee" value="<?php echo isset($flightPrice) ? $flightPrice : ''; ?>" placeholder="Flight Price" hidden>
                <input type="text" name="agentId" id="agentId" value="<?php echo $_SESSION['agentId']; ?>" placeholder="Agent Id" hidden>
                <input type="text" name="agentType" placeholder="Agent Type Input" value="<?php echo $_SESSION['agentType']; ?>" hidden>

                <!-- Adjusted Package Fields -->
                <input type="text" name="packageId" id="packageId" value="<?php echo isset($packageId) ? $packageId : ''; ?>" placeholder="Package Id Input" hidden>
                <input type="text" name="packageName" id="packageName" value="<?php echo isset($packageName) ? $packageName : ''; ?>" placeholder="Package Name Input" hidden>
                <input type="text" name="origin" id="origin" value="<?php echo isset($origin) ? $origin : ''; ?>" placeholder="Origin Input" hidden>
  ...
  <script>
    $(document).ready(function() {
      ...
      // Origin Book Now Button Click Event
      // $('#bookNowButton').click(function (event) 
      // {
      //   event.preventDefault(); // Prevent default form submission
