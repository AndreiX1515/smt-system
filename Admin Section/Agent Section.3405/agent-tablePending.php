      ...
      <?php
        ...
        if ($agentRole != 'Head Agent')
        {
          $sql1 = "SELECT b.transactNo AS `T.N`, p.packageName AS `PACKAGE`,
                ...
                WHERE b.accountId = $accountId AND (b.status = 'Pending' OR b.status = 'Reserved')
          ...
          else
          {
            echo "<tr>
                    <td colspan='7' class='text-center text-danger'>
                        No Pending/Reserved bookings found.
                    </td>
                  </tr>";
          }
        ...
        else
        {
          $sql1 = "SELECT b.transactNo AS `T.N`, p.packageName AS `PACKAGE`, br.branchName as branchName,
                    ...
                    JOIN branch br ON b.agentCode = br.branchAgentCode
                    WHERE b.agentCode = '$agentCode' AND (b.status = 'Pending' OR b.status = 'Reserved')
