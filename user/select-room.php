...
<head>
    ...
    <title><?php echoI18nText('book_now', $currentLang); ?> | <?php echoI18nText('smart_travel', $currentLang); ?></title>
    <link rel="stylesheet" href="../css/main.css">
    <script src="../js/counter.js" defer></script>
    <script src="../js/select-room.js" defer></script>
...
<body>
    <div class="main">
        ...
        <div class="mt16 px20 pb24 border-bottom10">
            ...
            <h3 class="text fz20 fw600 lh28 black12 mt24"><?php echoI18nText('select_room_title', $currentLang); ?></h3>
            <div class="card-type8 mt16">
                <div class="text fz16 fw600 lh24 black12" id="room-combination"><?php echoI18nText('current_room_combination', $currentLang); ?></div>
                <p class="text fz12 fw400 lh16 orangedb mt8"><?php echoI18nText('infant_room_note', $currentLang); ?></p>
            </div>
            <ul class="mt32" id="room-list">
                <!--   JavaScript   -->
            </ul>
        </div>
        <div class="px20 mt24" id="pricing-section">
            <!--   JavaScript   -->
        </div>
    </div>
</body>
